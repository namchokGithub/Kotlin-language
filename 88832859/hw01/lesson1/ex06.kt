...
class Team{
    ...
    public fun findTeamLeader(){
        for(member in this.teamMember){
            if(member.getPosition().equals("Team Leader", true)) println("${member.getName()}")
        }
    }
}
// Class Team
...
fun main(args: Array<String>) {
    ...
    team2.findTeamLeader()
}
// kotlinc ex06.kt -include-runtime -d ex06.jar && java -jar ex06.jar